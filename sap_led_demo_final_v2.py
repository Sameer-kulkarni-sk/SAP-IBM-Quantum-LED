#!/usr/bin/env python3
"""
LED SAP Demo - Final Version with Correct Pattern
Displays "SAP" on 8x8 LED matrix matching IBM demo format
"""
...
# Color definitions (RGB tuples) - matching IBM demo format
...
# SAP Pattern - 8x8 grid (64 pixels total)
# Each row is 8 pixels, reading left to right
# S in blue, A in gold, P in blue
SAP_Pattern = [
...
def generate_led_indices():
    """Generate LED indices using RasQberry utilities - EXACTLY like IBM demo"""
    try:
        ...
        print(f"Centering 8x8 display at offset ({start_x}, {start_y})")
...
def draw_sap(rainbow=False, hue_offset=0.0):
    ...
    if rainbow:
        ...
        pixels = [SAP_Pattern[i][:] for i in range(64)]
